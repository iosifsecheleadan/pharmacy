...
void help(){
    printf("Help screen:\n"
           ...
           "            add - add a medicine to your pharmacy\n"
           ...
           "            exit - exit farmacy (all modifications are lost)\n");
}
...
int main() {
    ...
    Vector* pharmacy = (Vector*) malloc(sizeof(pharmacy));
    ...
    while (1){
        ...
        else if (compareStrings(userInput, "add")) {
